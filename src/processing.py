...
def processar_serie_temporal_2026():
    ...
    # 1. Localiza o Shapefile na raiz ou pastas internas
    ...
    # 2. Inicializa a API Copernicus e coleta os dados de 2026
    api = CopernicusAPI()
