"""
sentinel_search.py
Busca da melhor cena Sentinel-2 L2A com suporte a TCI (RGB) e sessão customizada via StacApiIO.
"""
...
class CustomStacIO(StacApiIO):
    """
    Classe IO customizada estendendo StacApiIO para injetar o User-Agent
    em todas as requisições do pystac_client e evitar bloqueios WAF no GitHub Actions.
    """
